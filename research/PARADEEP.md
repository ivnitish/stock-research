...
- Retail fertilizer prices are fixed by government (no pricing power)
- Raw material (phosphoric acid) prices are volatile and dollar-denominated
- Revenue is in INR, raw materials in USD — forex risk
- With D/E 5.3x, even a single bad year of spreads (raw material spikes + govt subsidy delays) can create a cash crunch
- **Munger: "Never buy a commodity business with high debt. The combination kills."**
...
- When phosphoric acid prices are low (FY25 — global cooling), margins are better
- When raw material prices spike, profitability collapses
- With D/E 5.3x, a bad cycle year creates existential risk
...
- **Current Price:** ₹113
- **Market Cap:** ~₹11,639 Cr (103 Cr shares)
...
- [ ] D/E increases above 6x (any new debt)
- [ ] Net profit falls below ₹200 Cr (normalization / downturn)
- [ ] Subsidy policy changes unfavourably
- [ ] ROE falls below 10%
...
- **Key events to watch:**
  - Phosphoric acid price trends (Morocco/Jordan pricing)
  - Government DAP subsidy notifications
  - Ammonia-Urea complex progress + capex update
  - Any equity issuance to reduce debt
...
- **Critical finding: D/E 5.3x is unacceptable for a commodity fertilizer business.** This is the single biggest red flag.
- DCF uses FY25 profit (₹552 Cr) as base — this may be cyclically elevated. Normalized profit likely ₹200-300 Cr.
- With normalized FCF, the stock is significantly overvalued even at current ₹113 price.
- Only hold thesis: OCP Group promoter (world's largest phosphate producer) as strategic backer
- Grade C (11/25): MOAT 2, Management 2, Financials 2, Growth 3, Valuation 2
- **Recommendation: Do not add. Consider exiting on any recovery. Priority lower than SWIGGY/STL exits.**
