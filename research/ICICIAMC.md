# ICICI Prudential AMC (ICICIAMC.NS) — Investment Thesis
...
- Profit growth: 29%
- D/E: ~0
- Promoter: 87.59% (ICICI Bank + Prudential)
- P/E: 49.3x

---

## 4. The AMC Business Model

```
AUM grows → Fee income grows → Margins stay ~73% → Profit compounds
...
This is a capital-light flywheel. New AUM requires zero additional capital.
...
- Bear case (35x P/E, earnings slow): ₹2,100 (-29%)
- Base case (50x P/E, current): ₹2,936 (fair)
- Bull case (60x P/E, re-rating as MF growth accelerates): ₹3,520 (+20%)
...
- [ ] Passive funds (index ETFs) take >50% of new SIP flows (margin compression risk)
...
- Small position — consider meaningful addition on any correction below ₹2,400
- SEBI TER risk is the only real structural threat to monitor
