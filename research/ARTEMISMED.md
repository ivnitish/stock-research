...
- **Catalyst 1: VIMHANS expansion.** Adding 650 beds in South Delhi by FY29 is a 1.2x capacity increase. If successful, doubles revenue potential over 3-5 years.
- **Catalyst 2: Operating leverage.** As bed occupancy improves, fixed costs spread over larger revenue = OPM expansion from 16% → 20%+.
- **Catalyst 3: NCR premium healthcare.** Gurgaon/South Delhi market growing as corporate insurance coverage expands and medical tourism from smaller cities increases.
...
- [ ] Revenue growth falls below 10% for 2 quarters
- [ ] VIMHANS project cancelled or significantly delayed
- [ ] OPM declines below 12%
- [ ] Better hospital with stronger MOAT available at lower valuation
...
- **Key events to watch:**
  - Reason for promoter stake reduction (8% sold in FY25)
  - VIMHANS timeline and capex progress
  - Bed occupancy and ARPOB trends
  - Q-o-Q revenue growth trajectory
...
- Promoter sold ~10% of their holding in FY25 — this needs an explanation
- Both valuation models say overvalued by 35-60% even in bull case
- No meaningful MOAT vs Apollo/Medanta/Max in same geography
- **Consider trimming to 2-3% or exiting if promoter explanation is unsatisfactory**
...
- Revised read: Promoter sold to FIIs at scale — likely a liquidity event, not a loss of conviction. Still monitor for further reductions.
- Market pricing in 33% FCF CAGR for a single-hospital operator — seems aggressive
- VIMHANS expansion is the key catalyst, but execution risk + ₹500Cr capex is large for this company
- Grade C: 15/25. Still low conviction on fundamentals — valuation expensive, MOAT weak
- Quality Score: 15/25. MOAT 2, Management 3, Financials 3, Growth 4, Valuation 3.
