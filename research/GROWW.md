# Billionbrains Garage Ventures (GROWW.NS) — Investment Thesis
...
- **Catalyst 1: India demat account explosion.** ~15Cr demat accounts for 140Cr population (~10%). If this doubles in 5 years, Groww captures disproportionate share as largest platform.
...
### Quarterly Trend (Consolidated, Cr)
...
- [ ] ROCE drops below 30% for 2 consecutive quarters
- [ ] Revenue growth declines to <15% YoY for 2 quarters
- [ ] Promoter holding drops below 20%
- [ ] Major SEBI action structurally damaging broking economics
...
- **Key events to watch:**
  - SEBI F&O regulation updates
  - Quarterly active user numbers
  - Lending book growth and NPA ratios
  - Promoter lockup expiry dates
