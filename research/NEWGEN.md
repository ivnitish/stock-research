# Newgen Software Technologies (NEWGEN) — Investment Thesis
...
- **Revenue growth falls below 10% for 2 consecutive quarters** — signals structural demand loss, not seasonality
- **OPM falls below 20% consistently** — margin compression from pricing pressure (competitive threat from ServiceNow/low-cost entrants)
- **Subscription revenue growth decelerates below 15%** — the SaaS transition is the core long-term re-rating driver; if it stalls, the thesis changes
- **Stock price above ₹1,400** — at 35x+ P/E on FY29E earnings, most of the re-rating is done; trim and redeploy

### Where does this rank vs portfolio alternatives?

- vs **KAYNES** (Grade A, EMS): Kaynes has higher ROIC (34%) and clearer runway, but is more cyclically exposed to defence/electronics order flows. NEWGEN is more predictable. Both are core holdings.
- vs **ICICIAMC** (Grade A, AMC): ICICIAMC is the safer compounder — less AI risk, pure AUM-fee model. But NEWGEN has higher earnings CAGR and more re-rating potential. Different risk profiles.
- vs **EPACKPEB** (Grade B, PEB): EPACKPEB has more binary risk (capex cycle dependent) but 2-3x the earnings growth potential. NEWGEN is the steadier compounder in the portfolio.
...
### Near-term (FY26-FY27): Deceleration then re-acceleration
...
### Medium-term (FY28-FY29): US expansion is the growth engine
...
- US banks and insurers are accelerating digital transformation post-COVID
- Newgen's low-code/no-code pitch resonates with enterprises trying to reduce developer dependency
- Geographic diversification reduces India + Middle East customer concentration risk

### AI — Complement, Not Substitute
...
### P/E-Based Valuation (Primary Method for Software)
...
- **Price:** Significantly cheaper than ServiceNow/Pegasystems for comparable functionality — important in Middle East, Africa, APAC, and emerging market banks
- **Domain depth:** 17 verticals of pre-built industry logic — a bank deploying Newgen gets banking-specific workflows out of the box; ServiceNow's financial services module is more generic
- **Implementation speed:** Low-code configuration vs heavy custom development = faster time-to-value
...
- [ ] Revenue growth below 10% for 2 consecutive quarters (post-Q1 seasonality adjustment)
- [ ] OPM falls below 20% consistently — margin compression from competition
- [ ] Subscription revenue growth decelerates below 15% — SaaS transition stalling
- [ ] Promoter stake drops below 50% via open market sales
- [ ] Stock above ₹1,400 — 35x+ P/E on FY29E, most value realised

---

## 9. Review Schedule

- **Q4 FY26 results: May 5, 2026** — CRITICAL. Revenue ≥₹430 Cr = thesis intact. Below ₹380 Cr = revisit bear case.
- **Annual review:** April 2027 — after full FY27 results; reassess CAGR trajectory
- **Watch monthly:** Subscription revenue disclosure, FII holding trend, any AI-BPM displacement news
...
### 2026-04-19 — Full research rewrite
...
- FII holding at 14.48% — down from 17.34% noted earlier. Some institutional selling has occurred. Not alarming but monitor.
- Qatar court order (Apr 2026): USD 1.37M + QAR 200K. Small (~₹12 Cr) but signals international government contract execution risk.
- Q3 FY26 PAT (₹63 Cr) depressed by ₹35 Cr one-time labor code provision — adjusted ₹98 Cr = +10% YoY. The underlying business grew, the headline misled.
- ₹508 Cr investments on balance sheet = meaningful hidden asset (7% of market cap in liquid form).
- Subscription revenue growing 29% YoY in 9M FY26 — the SaaS transition is accelerating even as deal velocity slows. This is the most important long-term signal.
- US revenue growing 21% YoY — strongest geography, largest TAM, early innings.
- Base DCF fair value ₹430-450 (conservative); P/E based fair value ₹965 (base, FY29). Multiple re-rating from 21x → 28x is the primary return driver, not just earnings growth.
- Quality Score confirmed at 18/25 (Grade B+). Financials score raised to 5/5 (best-in-class balance sheet and ROIC for Indian software product companies). Valuation score at 2/5 — not cheap in absolute terms.
...
### 2026-03-12 — Initial thesis (Quick Summary)
- Entry ₹447.8. Thesis: 52% drawdown on AI fear, 33% profit CAGR, P/E 19.8x = value entry.
- See `research/archive/NEWGEN_v2.md` for original Quick Summary.
