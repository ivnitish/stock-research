...
- CFO: -₹2,169 Cr (FY25)
- IPO raised ~₹11,327 Cr (Nov 2024)
- At current burn rate of ₹2,000-3,000 Cr/year, Swiggy has **3-4 years of runway** before needing more capital
- This is enough runway to reach profitability IF the margin improvement trajectory holds
...
- Current quarterly revenue: ₹6,148 Cr (Dec 2025)
- Current OPM: -13% = ₹799 Cr quarterly loss
- Need: ₹799 Cr more contribution margin without adding proportional costs
- Revenue needs to scale to ~₹9,000-10,000 Cr/quarter while holding fixed costs flat
- At 54% YoY growth: ₹9,000 Cr/quarter possible by Q3 FY27 (Dec 2026)
- **Break-even: December 2026 or March 2027 — 9-12 months away**
...
- Blinkit (Eternal) is ahead in dark store count and brand recall
- Zepto (private, well-funded) is aggressive
- Swiggy Instamart is catching up but is #2 or #3 in this race
- Quick commerce is winner-take-most in each city — if Swiggy doesn't reach critical density, it loses
...
**Argument to HOLD:**
- Near 52-week low (₹271 low vs ₹281 current) — selling now is maximum pain point
- Margin improvement trajectory is real (-22% → -13% OPM in 3 quarters)
- Break-even in 9-12 months if trajectory holds
- IPO investors have 3-4 years of cash runway
- Base case shows 37% upside to ₹385

**Argument to EXIT:**
- Consistent losses with no profitability yet
- #2 position in both food delivery and quick commerce — always playing catch-up
- Zepto and Blinkit both ahead in the more valuable quick commerce segment
- At ₹72,909 Cr market cap with -18% OPM, expensive for the risk taken
- -48% P&L is deep loss; opportunity cost of holding through recovery is high
...
- [ ] OPM worsens from Dec 2025's -13% back above -18% → EXIT
- [ ] Zepto overtakes Swiggy in quick commerce GMV (verifiable via news) → reassess
- [ ] Management signals need for additional capital raise before profitability → EXIT (dilution risk)
- [ ] Instamart dark store count stagnates below 1,000 stores → thesis breaking
- [ ] Q4 FY26 (Mar 2026) OPM worse than -13% → reassess exit
...
- Swiggy is Eternal/Zomato 2-3 years ago. Loss-making but margins improving fast.
- OPM went from -22% (Mar 2025) to -13% (Dec 2025) — real improvement
- Break-even projected Dec 2026 - Mar 2027 if trajectory holds
- Key risk: #2 position in both food delivery AND quick commerce. Winner-take-most dynamics favor Eternal and Zepto.
- At near 52-week low, not the time to sell. Hold with hard stop: if Q4 FY26 OPM > -13%, exit.
- Quality Score: 10/25 (Grade C). Financials score 1 — everything negative. Growth score 4 because TAM is real.
- Base case: ₹385 (+37%). Bull case: ₹1,270 (+352%). Bear case: ₹154 (-45%).
