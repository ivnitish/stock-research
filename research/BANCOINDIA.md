# Banco Products (India) Ltd — Investment Thesis
...
**Source of high ROIC:**
- **OEM certification barrier** — 3-5 year qualification cycle. Once qualified, switching costs are high. Tata/M&M/Ashok Leyland won't re-qualify a new vendor for ₹5 savings per unit.
- **Scale advantage** — 3.33M radiator capacity, #1 in India at 21% share. Fixed cost absorption is better than any competitor.
- **NRF distribution moat** — 19 warehouses across Europe serving 80+ countries. Replicating this aftermarket network costs hundreds of crores.
- **Working capital efficiency** — mixed signal. OEM business has long receivable cycles, but NRF aftermarket collects faster.

### Q2: Is there a long reinvestment runway?

**TAM & headroom:**
- India automotive thermal management: ₹8,000-10,000 Cr (est.) → Banco at ₹1,600-1,800 Cr India revenue = ~18-22% penetration
- Global aftermarket (NRF): €50B+ → NRF at ~€200M = <1% penetration
- EV battery thermal management: new TAM entirely — per-vehicle thermal content is HIGHER for EVs (₹15,000-25,000 per EV vs ₹5,000-8,000 per ICE)
- Commercial vehicle recovery cycle in India not yet peaked
...
### Skin in the Game
- Promoter holding: **67.88%** — excellent
...
- Annual report MD&A is the primary communication channel
- No investor presentations found on BSE filings

### Capital Allocation Track Record
- NRF acquisition (2010): value-accretive — gave European distribution moat
- Banco Gaskets demerger (2013): kept as subsidiary — clean structure
- Banco New Energy Cooling Systems: early-stage EV bet — capital-light so far
- **Concern:** borrowings tripling without clear capex program disclosed
...
**Widening factors:**
- India's #1 radiator position with 21% market share — scale breeds more scale
- NRF European network — no Indian competitor has comparable aftermarket reach
- EV thermal management: Banco New Energy Cooling Systems is an early mover in India
- OEM qualification barrier: 3-5 years to qualify, switching is painful

**Narrowing risks:**
- Mahle/Denso could set up India capacity for thermal systems
- OEM consolidation could increase buyer power
- Commodity price swings (aluminium, copper) compress margins
...
- **Key corrections from old thesis:**
  ...
  - Revenue was estimated ~₹1,800 Cr — actual FY25 is ₹3,213 Cr (company is much bigger than previously stated)
  - OCF volatile: FY23 negative, FY25 only 0.42x PAT — this is a genuine concern
- **Downgraded 20/25 → 19/25** (Financials 5→4 due to debt and OCF correction)
- **Full data sourced from Screener.in**: 4-year P&L, balance sheet, cash flows, 7 quarters
- **Q3 FY26 (Dec 2025):** Revenue ₹789 Cr (+24% YoY, -24% QoQ), PAT ₹86 Cr (+177% YoY, -38% QoQ). Dec quarter structurally weak (both years).
- **9M FY26:** Revenue ₹2,776 Cr (+20%), PAT ₹334 Cr (+40%). On track for FY26 PAT ₹450-500 Cr.
- **Incremental ROIC 30.8%** — excellent compounding engine confirmed
- **Framework valuation:** Bear ₹340, Base ₹611, Bull ₹1,122 vs CMP ₹554. Roughly fairly valued with 10% upside at base.
- **No concall transcripts available** — Banco doesn't hold investor calls, which limits qualitative assessment
