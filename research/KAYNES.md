# Kaynes Technology India (KAYNES.NS) — Investment Thesis
...
- **Catalyst 1: India electronics manufacturing boom.** Govt targeting $500B electronics production by 2030 (from ~$100B). Kaynes positioned as quality domestic supplier.
- **Catalyst 2: Defence/aerospace localization.** Govt mandating indigenous content in defence procurement. Kaynes has DRDO/HAL relationships and defence certifications.
- **Catalyst 3: OSAT entry.** Kaynes entering semiconductor packaging (OSAT) — if successful, this is a massive margin and TAM expansion from EMS into semicon.
- **Catalyst 4: Operating leverage.** New facilities coming online (Chamarajanagar, Telangana). As utilization ramps, OPM could expand from 15% to 18-20%.
...
- **Current Price:** ₹3,726 (updated Mar 2026 — near 52-week low)
- **52-week range:** ₹3,295 – ₹7,705 (down **52% from peak**)
- **Market Cap:** ₹24,967 Cr
- **P/E (TTM):** 63x | **P/E (Forward):** 42x
- **P/B:** 5.2x | **Book Value:** ₹715/share
- **Shares Outstanding:** ~6.7 Cr
...
- DCF base: ₹1,669 → current price implies a 123% premium over fair value even with generous growth assumptions
- Even the bull case DCF (₹2,426) is 35% below CMP
- The stock is 52% below peak but remains expensive in absolute terms
- The right price to consider adding: <₹2,200 (between base and bull DCF)
- The promoter selling overhang (4.3% in 9 months from 57.9% → 53.5%) must resolve before increasing conviction
...
- [ ] Revenue growth drops below 20% YoY for 2 consecutive quarters
- [ ] OPM declines below 12% (margin erosion)
- [ ] Promoter holding drops below 45%
- [ ] OSAT project faces major delays or cost overruns
- [ ] Debt/Equity exceeds 1.0
...
- **Key events to watch:**
  - OSAT facility progress and timeline
  - New order wins (defence, automotive)
  - Quarterly margin trends
  - Capacity utilization at new plants
...
- Hold if conviction in OSAT + margin expansion is high
- Don't add at current levels — wait for correction or earnings to catch up
- This is a "hold and monitor" position, not an "add aggressively" one
...
**Revised thesis:**
- Business fundamentals are healthy (OPM 15-17%, not compressing)
- The stock fell 52% because capex peaked and FCF was deeply negative — market didn't like cash burn
- Capex is now normalizing. FY26 FCF should improve significantly
- BUT promoter selling of 4.3% is a serious concern — requires explanation
- D/E 0.33 is actually fine — the leverage concern was a data error
...
- At current pace, KAYNES is a "watch and wait" — monitor Q4 FY26 results and promoter filing

### 2026-03-11 — Initial thesis created
- Built 2-model valuation: DCF (very bearish at current price), P/B-ROE (bearish unless ROE improves to 20%+)
- Key insight: Market implies 53% FCF CAGR or 31% ROE — both aggressive vs actuals (49% sales CAGR, 11% ROE)
- The ROE gap (11% actual vs 31% implied) is concerning. KAYNES needs margin expansion + asset efficiency gains.
- OSAT entry is the key catalyst — if it works, transforms the business. If it doesn't, current valuation is hard to justify.
- Quality Score: 17/25 (Grade B). MOAT 3, Management 4, Financials 3, Growth 5, Valuation 2.
