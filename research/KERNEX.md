...
### 2026-04-09 — New orders + BHE JV + CMP update
...
- ₹91.12 Cr for 112 KAVACH equipment sets
- ₹411.17 Cr for 505 KAVACH onboard units
- Total: ₹502 Cr in fresh order inflows → order book grows from ₹3,268 Cr to ~₹3,770 Cr
...
- KAVACH v4.0 is the current mandate (fixed block signalling); Moving Block is the next-generation system (European Train Control System equivalent) that increases rail capacity by 30-40% without new tracks
- If Kernex is in the JV at the ground floor, it secures a position in the upgrade cycle that follows KAVACH deployment — not just the initial rollout but the subsequent modernization wave
- BHE brings manufacturing depth; Kernex brings RDSO-approved IP and Railways relationship
- Runway extension: from 44,000 km KAVACH mandate to potential 44,000 km Moving Block upgrade on top — doubles the addressable opportunity over a 15-20 year horizon
- No revenue contribution yet; this is optionality, not base case
