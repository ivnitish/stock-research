...
- Market share: ~55% (vs Swiggy ~40%)
- MTU (monthly transacting users): ~22 Cr
- GOV (gross order value): ~₹20,000 Cr/quarter, growing 15-20%
- Take rate: ~24% → improving
- **This segment is profitable** — operating profit positive for 8+ consecutive quarters

### Blinkit (quick commerce — the growth bet)
- Dark stores: 1,300+ (FY25), targeting 2,000+ by FY26
- GOV growing 100%+ YoY (from low base)
- **Currently loss-making** — dark store expansion is a capex/opex burn
- Break-even expected at 2,500-3,000 stores (management guidance)
- This is where most of the ₹2.14 lakh Cr market cap is being valued

### Hyperpure + Dining Out (small but interesting)
- Hyperpure: B2B supply chain, low margin but captive (restaurants locked in)
- Dining Out (District): early stage, potential sleeper
...
- Revenue TTM: ~₹42,905 Cr (consolidated)
- EV/Sales: ₹2.14 lakh Cr / ₹42,905 Cr = **5x**
- For a 2% operating margin business, 5x EV/Sales is very expensive
- Global peer Doordash trades at 2-3x EV/Sales. Meituan (China) at 2-3x.

### What Needs to Be True for Current Price to Be Fair?
At ₹2.14 lakh Cr market cap:
- If you want a 15x P/E (reasonable for a maturing company)
- You need PAT of ₹14,267 Cr
- On TTM revenue of ₹42,905 Cr, that requires **33% net margin**
- Food delivery mature businesses globally reach 15-20% net margins
- Blinkit quick commerce is structurally lower margin (logistics-heavy)
- **Blended 33% margin is essentially impossible for this business model**

More realistic target: 10-12% net margin (food delivery profitability + Blinkit break-even)
- At 12% margin on ₹60,000 Cr revenue (FY28 est.): PAT = ₹7,200 Cr
- At 40x P/E (growth premium): Fair value = ₹2,88,000 Cr = ₹299/share (+35% upside from ₹221)
- At 30x P/E: ₹2,16,000 Cr = ₹224/share (flat)
...
**Argument to HOLD:**
- Food delivery moat is real and Blinkit is the right long-term bet
- India's quick commerce market is genuinely underpenetrated
- FY26-27 Blinkit should approach break-even at 2,500+ stores
- If Blinkit margins reach 5%+ by FY28, this stock re-rates massively

**Argument to EXIT:**
- P/E 884x, forward P/E 100x — expensive by any standard
- Quarterly profit declining despite revenue growing (wrong direction)
- FIIs exiting aggressively (₹15,000+ Cr exit in 9 months)
- Base case fair value = current price (no margin of safety)
- Capital could compound faster in Just Dial (P/E 7.8x) or Balmer Lawrie
...
- [ ] Blinkit GOV growth decelerates below 50% for 2 quarters (thesis breaking)
- [ ] Total company operating profit turns negative again (regression)
- [ ] Deepinder Goyal steps down from CEO role
- [ ] Swiggy Instamart reaches parity in dark store count (competitive threat materializing)
- [ ] Q4 FY26 shows no improvement in quarterly PAT vs Mar 2025 ₹39 Cr → reassess exit
...
- Eternal (Zomato) is profitable but barely (₹527 Cr on ₹20,243 Cr revenue = 2.6% margin)
- Quarterly profit declining: ₹253 Cr → ₹176 Cr → ₹59 Cr → ₹39 Cr. Blinkit expansion burn.
- FII sold 8% of the company in 9 months — this is a significant concern
- At P/E 884x and ₹2.14 lakh Cr market cap, base case is flat to current price
- Bull case (Blinkit profitable at 3,000 stores) = ₹524/share (+137%)
- Bear case (Blinkit fails) = ₹42/share (-81%)
- Binary outcome stock. Hold for now, set hard review at Q4 FY26 results.
- Quality Score: 15/25 (Grade B). Valuation score 1 — expensive regardless of growth.
