...
- EBIT = Operating Profit ₹116 Cr + Other Income ₹6 Cr − Interest ₹24 Cr ≈ Operating Profit proxy = ₹116 Cr
- NOPAT = EBIT × (1 − tax rate) = ₹116 Cr × (1 − 27%) = **₹84.7 Cr**
- Capital Employed = Equity (₹16 + ₹337) + Borrowings ₹216 = **₹569 Cr**
- **ROCE = 84.7 / 569 = 14.9%** (lower than Screener's 23.7% — the difference is because Screener uses net fixed assets + working capital, not total CE. Using Screener's ROCE: **23.7%**)
...
- India PEB market: ~₹19,000 Cr ($2.3B) in 2025, growing to ~₹54,000 Cr ($6.5B) by 2034 at 12.4% CAGR
...
- Adding: Ghiloth (Rajasthan) — sandwich panels by Q3 FY27
- Adding: Mambattu (AP) — PEB expansion by Q4 FY26
...
- OPM dropping below 9% for 2 consecutive quarters
- Revenue run-rate falling below ₹300 Cr/quarter on a trailing basis
...
| | DCF | P/B-ROE | Weighted Avg (70/30) |
|---|---|---|---|
| Bear | ₹160 | ₹103 | ₹143 |
| Base | ₹260 | ₹183 | ₹237 |
| Bull | ₹396 | ₹252 | ₹353 |
...
- **Next quarterly check:** Q4 FY26 results (April/May 2026) — **THE critical check.** Must deliver ₹400+ Cr revenue to hit FY26 guidance.
- **Key events to watch:**
  - Q4 FY26 results: revenue, OPM, order book update
  - Mambattu (AP) facility commissioning (Q4 FY26 expected)
  - Ghiloth (Rajasthan) sandwich panel facility (Q3 FY27 expected)
  - Gujarat (Vithlapur) Phase 1 progress
  - Steel price trends (HRC/domestic)
  - Annual report FY26 — related party transactions detail
