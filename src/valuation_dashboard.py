...
TARGETS = {
    ...
    "EPACKPEB":   {"yf": "EPACKPEB.NS",    "fair": 500,   "method": "P/E 22x FY29E (de-rate done; PAT-growth play; trim 23%->17%)"},
    "KERNEX":     {"yf": "KERNEX.NS",      "fair": 1800,  "method": "P/E 30x FY29E (hold-don't-add above ₹1,050; 43x trailing already rich)"},
    ...
    "RAYMOND":    {"yf": "RAYMOND.NS",     "fair": 1100,  "method": "Post-realty-demerger SOTP: Aerospace+Defence (Maini/Boeing/Airbus) + Auto Components; bull ₹1,800"},
