...
def main():
    # Retired 2026-07-20. index.html is now auto-generated by
    # scripts/build_site_index.py (rows already ordered by verdict then score),
    # and has no hand-maintained "PORTFOLIO HOLDINGS" section for this script to
    # sort. Running it would corrupt the generated index. Kept for history only.
    print("⚠ sort_index_by_amount.py is retired — index.html is auto-generated.")
    print("  Run: venv/bin/python3 scripts/build_site_index.py")
    return
